  ...
  constructor() {
    this.shaderFactory = new ShaderFactory(Effect.getNick(), (shader) => {
      ...
      shader.connect('begin-animation', (shader, settings) => {
        // clang-format off
        shader.set_uniform_float(shader._uScale, 1,  [settings.getValue('glide-scale')]);
        shader.set_uniform_float(shader._uSquish, 1, [settings.getValue('glide-squish')]);
        shader.set_uniform_float(shader._uTilt, 1,   [settings.getValue('glide-tilt')]);
        shader.set_uniform_float(shader._uShift, 1,  [settings.getValue('glide-shift')]);
        // clang-format on
      });
    });
  }
