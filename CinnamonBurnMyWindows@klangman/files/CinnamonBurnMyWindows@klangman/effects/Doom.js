    ...
    this.shaderFactory = new ShaderFactory(Effect.getNick(), (shader) => {
      ...
      shader.connect(
        'begin-animation', (shader, settings, forOpening, testMode, actor) => {
          ...
          shader.set_uniform_float(shader._uHorizontalScale, 1, [testMode ? 50.0 :settings.getValue('doom-horizontal-scale')]);
          shader.set_uniform_float(shader._uVerticalScale,   1, [testMode ? 150.0 : settings.getValue('doom-vertical-scale')]);
          shader.set_uniform_float(shader._uPixelSize,       1, [settings.getValue('doom-pixel-size')]);
          // clang-format on
        });
    });
  }
