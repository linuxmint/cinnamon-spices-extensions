  ...
  constructor() {
    this.shaderFactory = new ShaderFactory(Effect.getNick(), (shader) => {
      ...
      shader.connect('begin-animation', (shader, settings) => {
        // clang-format off
        shader.set_uniform_float(shader._uNoise,     1, [settings.getValue('pixelate-noise')]);
        shader.set_uniform_float(shader._uPixelSize, 1, [settings.getValue('pixelate-pixel-size')]);
        // clang-format on
      });
    });
  }
