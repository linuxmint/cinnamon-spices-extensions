  ...
  constructor() {
    this.shaderFactory = new ShaderFactory(Effect.getNick(), (shader) => {
      ...
      shader.connect('begin-animation', (shader, settings, forOpening, testMode) => {
        const c = Clutter.Color.from_string(settings.getValue('tv-glitch-color'))[1];
        ...
        shader.set_uniform_float(shader._uScale, 1, [settings.getValue('tv-glitch-scale')]);
        shader.set_uniform_float(shader._uStrength, 1, [settings.getValue('tv-glitch-strength')]);
        shader.set_uniform_float(shader._uSpeed, 1, [settings.getValue('tv-glitch-speed')]);
        // clang-format on
      });
    });
  }
