  ...
  constructor() {
    this.shaderFactory = new ShaderFactory(Effect.getNick(), (shader) => {
      ...
      shader.connect('begin-animation', (shader, settings) => {
        // clang-format off
        shader.set_uniform_float(shader._uPixelSize,  1, [settings.getValue('pixel-wheel-pixel-size')]);
        shader.set_uniform_float(shader._uSpokeCount, 1, [settings.getValue('pixel-wheel-spoke-count')]);
        // clang-format on
      });
    });
  }
