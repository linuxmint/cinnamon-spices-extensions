...
const StockWindowMenu = imports.ui.windowMenu;

var orig_window_menu = StockWindowMenu.WindowMenu;
var orig_ornamented_menu_item = StockWindowMenu.LeftOrnamentedMenuItem;
...
function enable() 
{
    StockWindowMenu.WindowMenu = MnemonizedWindowMenu;
    StockWindowMenu.LeftOrnamentedMenuItem = MnemonicLeftOrnamentedMenuItem;
}

function disable() 
{
    StockWindowMenu.WindowMenu = orig_window_menu;
    StockWindowMenu.LeftOrnamentedMenuItem = orig_ornamented_menu_item;
}
...
var MnemonizedWindowMenu = class extends PopupMenu.PopupMenu {
